fun main(args: Array<String>) {
    val hexDecoder = HexDecoder()
    val strings = arrayOf("280dc9e47f3352c307f6d894ee8d534313429a79c1d8a6021f8a8eabca919cfb685a0d468973625e757490daa981ea6b",
    ...
    val ciphers = ArrayList<CharArray>()
    val salsa20Decoder = Salsa20Decoder()

    for (string in strings) {
        ciphers.add(hexDecoder.decode(string).toCharArray())
    }

    salsa20Decoder.decode(ciphers, "For who would bear the whips and scorns of time,")
//    "The " -> "That " -> "But that " -> "And makes " -> "Than fly to " -> "For who would "
}